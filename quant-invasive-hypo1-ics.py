...
hypo1_physicell_output_directories = "../PhysiCell/output/hypothesis1_ics_permuted/"
...
for j, d in enumerate(tqdm(hypo1_out_dirs)):
    ...
    selected_steps = utils.load_simulation_by_interval("../PhysiCell/output/hypothesis1_ics_permuted/"+d+"/")
...
hypo1_simulation_results_df.to_csv("../output/tables/hypothesis1_invasiveness_random_ics_2.csv")
