...
hypo2_physicell_output_directories = "../PhysiCell/output/hypothesis2_random_seeds/"
...
for j, d in enumerate(tqdm(hypo2_out_dirs)):
    ...
    selected_steps = utils.load_simulation_by_interval("../PhysiCell/output/hypothesis2_random_seeds/"+d+"/")
...
hypo2_simulation_results_df.to_csv("../output/tables/hypothesis1_invasiveness_random_seeds.csv")
